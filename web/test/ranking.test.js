...
test('Rankings matches the Expo pilot: list plus Compare duel mode', () => {
  ...
  assert.match(rankings, /section === 'compare'/)
  assert.match(rankings, /This one/)
  assert.match(rankings, /chooseRankingPair/)
  assert.match(rankings, /RANK_REACTIONS/)
  assert.match(rankings, /setRankReaction/)
  assert.match(rankings, /recordComparison/)
  assert.doesNotMatch(rankings, /rank-tier/)
