...
//
// The v8 artwork is the hand-approved Japandi raster master (warm amber glass
// stack on a warm charcoal field). Source assets live in web/assets/icon-v8; this script validates their dimensions,
