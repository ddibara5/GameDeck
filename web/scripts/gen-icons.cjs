...
//
// The v10 artwork is the flat "classic" Japandi master (flat amber layers, no
// glass, on the same warm charcoal field). Source assets live in web/assets/icon-v10; this script validates their dimensions,
